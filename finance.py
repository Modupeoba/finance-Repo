...
st.markdown("<h4 style = 'margin: -30px; color: #416D19; text-align: center; font-family: Self Deception'> Built by OBAMUYI M.V. </h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('38435-removebg-preview.png', width = 700)
...
st.sidebar.image('3999989-removebg-preview.png', width = 300, caption = 'Welcome User')
st.sidebar.divider()
...
model = joblib.load('FinanceModel.pkl')
